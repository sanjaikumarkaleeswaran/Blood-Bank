...
public class coneg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coneg);
        listViewDonors = findViewById(R.id.coneg);
        final String[] capos= {
        ...
        listViewDonors.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(coneg.this, donorDetails, Toast.LENGTH_SHORT).show();
            }
        });
    }
}